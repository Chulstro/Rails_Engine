...
RSpec.describe "When calling for Merchant revenue" do
  it "will return the highest earning merchants" do
    ...
    expect(body['data'][0]['id']).to eq("#{merchant_3.id}")
    expect(body['data'][1]['id']).to eq("#{merchant_1.id}")
  end
end
